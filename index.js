...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// the function can access the variable inernal because it is with the "myFunction" scope
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    let lowerCase = zooAnimals.map(function(element) {
  ...
  */
  ...
  function lowPopulationAnimals(){
    let lowPopAnimals = zooAnimals.filter(function(element) {
...
CuboidMaker.prototype.volume = funtion(length, wdth, height) {
